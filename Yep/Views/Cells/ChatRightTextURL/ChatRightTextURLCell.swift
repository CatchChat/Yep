...
final class ChatRightTextURLCell: ChatRightTextCell {
    ...
    override func configureWithMessage(message: Message, textContentLabelWidth: CGFloat, mediaTapAction: MediaTapAction?) {

        bottomGap = 100 + 10

        super.configureWithMessage(message, textContentLabelWidth: textContentLabelWidth, mediaTapAction: mediaTapAction)
