...
class LeftShareFeedCell: ChatBaseCell {
    ...
    let borderImageView: UIImageView = {
        // TODO: WRONG IMAGE
       let imageView = UIImageView(image: UIImage(named: "chat_sharetopicbubble"))
        return imageView
    }()
    ...
    override init(frame: CGRect) {
        ...
        borderImageView.addGestureRecognizer(tap)
...
/*
 Optional(Conversation {
	type = 1;
	updatedUnixTime = 1461140049.017926;
	withFriend = (null);
	withGroup = Group {
 groupID = bd41ec629c7a24933069fc3ef6d613ed;
 groupName = ;
 notificationEnabled = 1;
 createdUnixTime = 1461140049.015901;
 owner = (null);
 groupType = 0;
 includeMe = 0;
 members = RLMArray <0x115f8e490> (
 
 );
 withFeed = Feed {
 feedID = bd41ec629c7a24933069fc3ef6d613ed;
 allowComment = 1;
 createdUnixTime = 1461053534.864;
 updatedUnixTime = 1461129268.836;
 creator = User {
 userID = cf292b334af37778c2f92612cb4aa4c2;
 username = kevinzhow;
 nickname = Kevin;
 introduction = Founder of Catch;
 avatarURLString = https://s3.cn-north-1.amazonaws.com.cn/yep-avatars/a6088cc6-c74d-4e88-9e06-c88fd9857fdc-1455380485.jpg;
 avatar = Avatar {
 avatarURLString = https://s3.cn-north-1.amazonaws.com.cn/yep-avatars/a6088cc6-c74d-4e88-9e06-c88fd9857fdc-1455380485.jpg;
 avatarFileName = F6E57DF4-FA86-4AF7-9F70-60834A63F98E;
 roundMini = <89504e47 0d0a1a0a 0000000d 49484452 00000078 00000078 — 11060 total bytes>;
 roundNano = <89504e47 0d0a1a0a 0000000d 49484452 00000050 00000050 — 5935 total bytes>;
 };
 badge = tech;
 createdUnixTime = 1461048518.954341;
 lastSignInUnixTime = 1461219387;
 friendState = 2;
 friendshipID = 904cc6f48e126bf36cf2739007582dd4;
 isBestfriend = 0;
 bestfriendIndex = 0;
 longitude = 116.597;
 latitude = 39.9228;
 ...
 blocked = 0;
 doNotDisturb = (null);
 learningSkills = RLMArray <0x10af485d0> (
 [0] <Maximum depth exceeded>,
 [1] <Maximum depth exceeded>,
 [2] <Maximum depth exceeded>,
 [3] <Maximum depth exceeded>,
 [4] <Maximum depth exceeded>,
 [5] <Maximum depth exceeded>,
 [6] <Maximum depth exceeded>,
 [7] <Maximum depth exceeded>,
 [8] <Maximum depth exceeded>
 );
 masterSkills = RLMArray <0x115f38b80> (
 [0] <Maximum depth exceeded>,
 [1] <Maximum depth exceeded>,
 [2] <Maximum depth exceeded>,
 [3] <Maximum depth exceeded>,
 ...
 socialAccountProviders = RLMArray <0x1191b5210> (
 [0] <Maximum depth exceeded>,
 [1] <Maximum depth exceeded>,
 [2] <Maximum depth exceeded>
 );
 ...
 skillCategoryID = 90913b93738c8a627129e49db32eeec3;
 name = Technology;
 localName = Technology;
 };
 skillID = 7fd72edb066fd031c2748172d34cbbbb;
 name = ios;
 localName = iOS;
 coverURLString = https://yep-avatars.s3.cn-north-1.amazonaws.com.cn/97b1d79a-fd64-45b0-a2cf-232024846ba4;
 };
 group = Group {
 groupID = bd41ec629c7a24933069fc3ef6d613ed;
 groupName = ;
 ...
 createdUnixTime = 1461053534.864;
 updatedUnixTime = 1461129268.836;
 creator = <Maximum depth exceeded>;
 distance = 0;
 messagesCount = 10;
 body = 特地配色;
 kind = image;
