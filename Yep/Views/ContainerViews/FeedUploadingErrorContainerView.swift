...
class FeedUploadingErrorContainerView: UIView {
    ...
    lazy var retryButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(retryUploadingFeed(_:)), forControlEvents: .TouchUpInside)
        return button
    }()
    ...
    lazy var deleteButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(deleteUploadingFeed(_:)), forControlEvents: .TouchUpInside)
        return button
    }()
