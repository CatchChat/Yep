...
class RegisterPickNameViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(tapTerms(_:)))
        ...
        nameTextField.addTarget(self, action: #selector(textFieldDidChange(_:)), forControlEvents: .EditingChanged)
