...
class LoginByMobileViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        areaCodeTextField.addTarget(self, action: #selector(textFieldDidChange(_:)), forControlEvents: .EditingChanged)
        ...
        mobileNumberTextField.addTarget(self, action: #selector(textFieldDidChange(_:)), forControlEvents: .EditingChanged)
